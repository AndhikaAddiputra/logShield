...
export default function App() {
  ...
  useEffect(() => {
    // Area ini dieksekusi sekali saat aplikasi pertama kali dibuka.
    // Di sinilah tempat yang ideal untuk menginisialisasi basis data lokal 
    // (misalnya membuat instance PouchDB) dan memulai proses replikasi/sinkronisasi 
    // ke server pusat (seperti CouchDB) agar fitur offline-first berjalan di latar belakang.
  }, []);

  return (
    // Memanggil kerangka utama aplikasi yang sudah memuat halaman dan navigasi
    <AppLayout />
  );
}
